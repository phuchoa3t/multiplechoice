...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<label class="col-sm-3 control-label"><?php echo $form->labelEx($model,'rs_id'); ?>
</label>
		<div class="col-sm-5">
			<?php echo $form->textField($model,'rs_id', array('class'=>'form-control')); ?>
			<?php echo $form->error($model,'rs_id'); ?>
		</div>
	</div>
	<div class="form-group">
