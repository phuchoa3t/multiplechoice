...
class ExamcodeController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Examcode'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Examcode');
	...
	*/
	...
	public function actionIndex()
	{
		$model=new Examcode('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Examcode']))
			$model->attributes=$_GET['Examcode'];
	 ...
	 * @return Examcode the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Examcode::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Examcode $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='examcode-form')
		{
